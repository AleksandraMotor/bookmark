    ...
    return (
        <div className='navigation-mobile'>
            ...
            <div className={classNames({
                ...
                <div className='navigation-mobile__menu__list'>
                    <span className='navigation-mobile__menu__list__item'>features</span>
                    <span className='navigation-mobile__menu__list__item'>pricing</span>
                    <span className='navigation-mobile__menu__list__item'>contact</span>
                    <span className='navigation-mobile__menu__list__item'>
                        <Button type='white'>LOGIN</Button>
                    </span>
                </div>
                <div className='navigation-mobile__menu__social-media'>
